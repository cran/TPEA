...
function(pathwayList,ambiguousEdgeDirection="bi-directed",ambiguousEdgeList=c("unknow","compound","hidden compound","state change","binding/association","dissociation"),simpleGraph=TRUE,splitCompoundSubType=TRUE,verbose=FALSE){
